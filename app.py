...
if year == 2024:
    ...
    df_f.read_parquet_parquet("mujeres24.parquet")
elif year == 2023:
    df_m.read_parquet("hombres23.parquet")
    df_f.read_parquet("mujeres23.parquet")
else year == 2022:
    df_m.read_parquet("hombres22.parquet")
    df_f.read_parquet("mujeres22.parquet")
